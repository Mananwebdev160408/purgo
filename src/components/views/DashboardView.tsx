  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-fluent-cardDark border border-fluent-cardBorderDark rounded-xl p-6 flex flex-col justify-between space-y-6">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-fluent-blue hover:bg-fluent-blueHover text-white text-xs font-semibold rounded-lg shadow-md transition-all active:scale-[0.99]"
            >
        ...
        <div className="lg:col-span-2 bg-fluent-cardDark border border-fluent-cardBorderDark rounded-xl p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-xs text-fluent-blue hover:underline font-medium flex items-center gap-1"
              >
            ...
            <div className="space-y-3">
              {topConsumers.map((proj) => (
                <div
                  key={proj.id}
                  className="flex items-center justify-between p-3.5 bg-fluent-bgDark border border-fluent-cardBorderDark rounded-xl hover:border-fluent-blue/40 transition-all"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-fluent-cardDark border border-fluent-cardBorderDark flex items-center justify-center font-bold text-xs text-fluent-blue">
          ...
          <div className="pt-4 border-t border-fluent-cardBorderDark flex items-center justify-between text-xs text-fluent-textSecondaryDark">
            ...
            <button onClick={() => setActiveTab('artifacts')} className="text-fluent-blue font-medium hover:underline">
      ...
      <div className="bg-fluent-cardDark border border-fluent-cardBorderDark rounded-xl p-6 space-y-4">
        ...
        {isScanning && (
          <div className="flex items-center gap-3 p-3 bg-fluent-blue/10 border border-fluent-blue/30 rounded-lg text-xs text-fluent-blue">
          ...
          {heaviestLargeFile ? (
            <div className="p-4 bg-fluent-bgDark border border-fluent-cardBorderDark rounded-xl space-y-2">
              ...
              <p className="text-xs text-fluent-textSecondaryDark">
                ...
                {' '}Review it in <button onClick={() => setActiveTab('large-files')} className="text-fluent-blue hover:underline">Large File Finder</button>.
              </p>
            </div>
          ) : (
            <div className="p-4 bg-fluent-bgDark border border-fluent-cardBorderDark rounded-xl space-y-2 opacity-50">
          ...
          <div className="p-4 bg-fluent-bgDark border border-fluent-cardBorderDark rounded-xl space-y-2">
            ...
            <p className="text-xs text-fluent-textSecondaryDark">
              {trashItems.length > 0
                ...
                : <>Purgo never permanently deletes files immediately. All items remain restorable for 30 days in <span className="text-fluent-blue font-medium">Purgo Trash</span>.</>
              }
            </p>
          </div>
        </div>
