...
const ECOSYSTEM_GROUP: Record<EcosystemType, { label: string; color: string }> = {
  'Node.js':   { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'React':     { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Next.js':   { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Vite':      { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Vue':       { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Nuxt':      { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Angular':   { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Svelte':    { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Remix':     { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Astro':     { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Electron':  { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Bun':       { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Deno':      { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'Express':   { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
  'NestJS':    { label: 'JavaScript / Node.js', color: 'bg-fluent-blue' },
